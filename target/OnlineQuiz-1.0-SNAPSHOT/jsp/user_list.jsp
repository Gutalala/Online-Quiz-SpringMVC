...
<ul class="cd-hero-slider">
    <div style="background-color:transparent; position: absolute; left: 50%; top: 40%; padding: 10px; transform: translate(-50%, -50%);">
        <table id="table_id" class="display">
            ...
            <tbody>
            <C:forEach var="user" items="${requestScope.userList}" varStatus="counter">
                <tr>
